...
CARD_CATALOG = (
        ...
        UnitStats(
            ...
            spawner=SpawnerStats(
                card=SpawnedCard(
                    ...
                    attack_style="melee",
                    unit_count=2,
                    unit_stats=_SKELETON_STATS,
                ),
                interval_seconds=3.3,
                initial_delay_seconds=3.3,
            ),
        ),
        None,
    ),
    ...
    Card(
        ...
        0,
        None,
        SpellStats(1484, 445, 2.0, knockback_distance=2.0),
    ),
    Card(
        "Ice Spirit",
        1,
